...
const Footer = () => {
  return (
    <section>
      <div className="max-w-8xl mx-auto flex flex-col px-6 py-20 lg:px-10 xl:px-24 bg-[#201F1D]">
        {/* <!-- LOGO --> */}

        {/* <!-- MIDDLE CONTAINER --> */}
        <div className="mt-7 lg:flex lg:flex-row lg:justify-between">
          {/* <!-- FOOTER LINKS --> */}
          <div className="flex grow flex-row flex-wrap lg:flex-nowrap lg:items-start text-[#828282]">
            {/* <!-- LINK BLOCK --> */}
            <div className="mb-5 mr-8 flex max-w-[300px] grow basis-[100px] flex-col space-y-5">
              <div className="flex flex-col">
                <h2 className="font-inter font-medium text-white">About Company</h2>
                <span className="w-8 h-1 bg-color-orange"></span>
              </div>
              <Link
                to='/'
                className="font-inter font-light text-color-gray fontbold"
              >
                Marketing
              </Link>
              <Link
            ...
            <div className="mb-5 mr-8 flex max-w-[300px] grow basis-[100px] flex-col space-y-5">
              <div className="flex flex-col">
                <h2 className="font-inter font-medium text-white">Vehicles Type</h2>
                <span className="w-8 h-1 bg-color-orange"></span>
              </div>
              <Link
                to='/'
            ...
            <div className="mb-5 mr-8 flex max-w-[300px] grow basis-[100px] flex-col space-y-5">
              <div className="flex flex-col">
                <h2 className="font-inter font-medium text-white">Quick links</h2>
                <span className="w-8 h-1 bg-color-orange"></span>
              </div>
              <Link
                to='/'
          ...
          <div className="flex flex-col">
            <form action="" className="max-w-[421px]">
              ...
              <div className="flex flex-col">
                <h2 className="font-inter font-medium text-white">Contact Info</h2>
                <span className="w-8 h-1 bg-color-orange"></span>
              </div>
                <div className="mt-4 flex flex-col md:flex-row">
                  <input
                    type="email"
                    className="mr-6 block h-9 w-full border-black bg-[#f2f2f7] px-6 py-7 align-middle text-sm text-[#333333] focus:border-[#3898ec]"
                    maxLength="256"
                    name="email"
                  ...
                  <input
                    type="submit"
                    value="Subscribe"
                    className="mt-5 inline-block cursor-pointer bg-color-orange px-6 py-3 text-center font-semibold text-white transition [box-shadow:rgb(171,_196,_245)_-8px_8px] hover:[box-shadow:rgb(171,_196,_245)_0px_0px] md:mt-0"
                  />
                </div>
              </div>
            </form>
            <div>
              <h3
                htmlFor="email"
                className="font-inter mb-4 mt-8 font-medium text-color-gray"
              >
                EMAIL US
              </h3>
              <p className="text-color-gray text-base">tanjilhossain845@gmail.com</p>
            </div>
          </div>
        </div>
        {/* <!-- DIVIDER --> */}
        ...
        <div className="lg:flex lg:flex-row-reverse lg:justify-between">
          ...
          <p className="font-inter text-sm text-white font-semibold">
            ...
            <span className="text-color-orange">Tanjil Hossain.</span>
          </p>
        </div>
      </div>
    </section>
